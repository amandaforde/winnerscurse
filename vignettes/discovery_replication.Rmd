...
A third method has been added which obtains a new association estimate for each significant SNP in the data set using a combination of the discovery and replication estimates:
